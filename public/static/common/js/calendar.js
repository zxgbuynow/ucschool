(function(root, factory) {
    ...
    var defaults = {
            ...
            onYearSwitched:function(view,date,value){
        ...
        MONTH_ITEM_TPL = '<li ' + ITEM_STYLE + ' ' + ITEM_MONTH + '><a href="javascript:;">{m}<span>月</span><i></i></a></li>',
    ...
    Calendar.prototype = {
        ...
        event: function() {
			...
			*/
            ...
            _this.$element/*.on('click', ARROW_DATE, function() {
                ...
                vc('month', y);
				_this.options.onYearSwitched.call(this,'date',y,$(this).data(MARK_DATA));
            });
            ...
            _this.$element/*.on('click', '[' + ITEM_DAY + ']', function() {
                ...
                var y = Number(_this.$disMonth.html()),
					...
					m = parseInt($(this).find('a')[0].innerHTML);
                //_this.updateDateView(y, m);
                //vc('date', y, m);
                _this.options.onSelected.call(this, 'month', new Date(y, m - 1));
            });

			_this.$element.on('click', '.currentmonth', function() {
				var y = _this.date.getFullYear();
				_this.setMonthAction(y);
				$(".calendar-hd a").text(y);
				_this.options.onBackToCurrent.call(this,'date',y);
			})
        ...
        init: function() {
            ...
            this.resize();
            this.render();
            this.view = this.options.view; //month
