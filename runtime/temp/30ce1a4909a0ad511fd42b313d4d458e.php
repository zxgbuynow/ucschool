...
<head>
    ...
    <link rel="shortcut icon" href="__SHOP_IMG__/favicons/favicon.ico">

    <link rel="icon" type="image/png" href="__SHOP_IMG__/favicons/favicon-16x16.png" sizes="16x16">
    <link rel="icon" type="image/png" href="__SHOP_IMG__/favicons/favicon-32x32.png" sizes="32x32">
    <link rel="icon" type="image/png" href="__SHOP_IMG__/favicons/favicon-96x96.png" sizes="96x96">
    <link rel="icon" type="image/png" href="__SHOP_IMG__/favicons/favicon-160x160.png" sizes="160x160">
    <link rel="icon" type="image/png" href="__SHOP_IMG__/favicons/favicon-192x192.png" sizes="192x192">

    <link rel="apple-touch-icon" sizes="57x57" href="__SHOP_IMG__/favicons/apple-touch-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="__SHOP_IMG__/favicons/apple-touch-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="__SHOP_IMG__/favicons/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="__SHOP_IMG__/favicons/apple-touch-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="__SHOP_IMG__/favicons/apple-touch-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="__SHOP_IMG__/favicons/apple-touch-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="__SHOP_IMG__/favicons/apple-touch-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="__SHOP_IMG__/favicons/apple-touch-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="__SHOP_IMG__/favicons/apple-touch-icon-180x180.png">
    <!-- END Icons -->
    ...
    <link rel="stylesheet" href="__SHOP_CSS__/dolphin.css" id="css-main">
    <?php endif; ?>
    <link rel="stylesheet" id="css-theme" href="__SHOP_CSS__/themes/<?php echo config('system_color'); ?>.min.css">
    ...
    <!--自定义css-->
    <link rel="stylesheet" href="__SHOP_CSS__/custom.css">
    <script>
        // url
        var dolphin = {
            'top_menu_url': '<?php echo url("shop/ajax/getSidebarMenu"); ?>',
            'theme_url': '<?php echo url("shop/ajax/setTheme"); ?>',
            'jcrop_upload_url': '<?php echo !empty($jcrop_upload_url)?$jcrop_upload_url : url("shop/attachment/upload", ["dir" => "images", "from" => "jcrop", "module" => request()->module()]); ?>',
            'editormd_upload_url': '<?php echo !empty($editormd_upload_url)?$editormd_upload_url : url("shop/attachment/upload", ["dir" => "images", "from" => "editormd", "module" => request()->module()]); ?>',
            'editormd_mudule_path': '__LIBS__/editormd/lib/',
            'ueditor_upload_url': '<?php echo !empty($ueditor_upload_url)?$ueditor_upload_url : url("shop/attachment/upload", ["dir" => "images", "from" => "ueditor", "module" => request()->module()]); ?>',
            'wangeditor_upload_url': '<?php echo !empty($wangeditor_upload_url)?$wangeditor_upload_url : url("shop/attachment/upload", ["dir" => "images", "from" => "wangeditor", "module" => request()->module()]); ?>',
            'wangeditor_emotions': "__LIBS__/wang-editor/emotions.data",
            'ckeditor_img_upload_url': '<?php echo !empty($ckeditor_img_upload_url)?$ckeditor_img_upload_url : url("shop/attachment/upload", ["dir" => "images", "from" => "ckeditor", "module" => request()->module()]); ?>',
            'WebUploader_swf': '__LIBS__/webuploader/Uploader.swf',
            'file_upload_url': '<?php echo !empty($file_upload_url)?$file_upload_url : url("shop/attachment/upload", ["dir" => "files", "module" => request()->module()]); ?>',
            'image_upload_url': '<?php echo !empty($image_upload_url)?$image_upload_url : url("shop/attachment/upload", ["dir" => "images", "module" => request()->module()]); ?>',
            'upload_check_url': '<?php echo !empty($upload_check_url)?$upload_check_url : url("shop/ajax/check"); ?>',
            'get_level_data': '<?php echo url("shop/ajax/getLevelData"); ?>',
            'quick_edit_url': '<?php echo !empty($quick_edit_url)?$quick_edit_url : url("quickEdit"); ?>',
            'aside_edit_url': '<?php echo !empty($aside_edit_url)?$aside_edit_url : url("shop/system/quickEdit"); ?>',
            ...
            'get_filter_list': '<?php echo url("shop/ajax/getFilterList"); ?>',
    ...
    <aside id="side-overlay">
        ...
        <div id="side-overlay-scroll">
            ...
            <div class="side-header side-content">
                ...
                <span>
                    <img class="img-avatar img-avatar32" src="<?php echo get_avatar(\think\Session::get('shop_auth.uid')); ?>" alt="">
                    <span class="font-w600 push-10-l"><?php echo session('shop_auth.username'); ?></span>
                </span>
            </div>
            <!-- END Side Header -->
            <!--侧栏-->
        ...
        <div id="sidebar-scroll">
            ...
            <div class="sidebar-content">
                ...
                <div class="side-header side-content bg-white-op dolphin-header">
                    ...
                    <div class="btn-group pull-right">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right font-s13 sidebar-mini-hide">
                            <li <?php if($system_color=='modern') echo  'class="active"'; ?>>
                                <a data-toggle="theme" data-theme="modern" data-css="__SHOP_CSS__/themes/modern.min.css" tabindex="-1" href="javascript:void(0)">
                                    <i class="fa fa-circle text-modern pull-right"></i> <span class="font-w600">Modern</span>
                                </a>
                            </li>
                            <li <?php if($system_color=='amethyst') echo  'class="active"'; ?>>
                                <a data-toggle="theme" data-theme="amethyst" data-css="__SHOP_CSS__/themes/amethyst.min.css" tabindex="-1" href="javascript:void(0)">
                                    <i class="fa fa-circle text-amethyst pull-right"></i> <span class="font-w600">Amethyst</span>
                                </a>
                            </li>
                            <li <?php if($system_color=='city') echo  'class="active"'; ?>>
                                <a data-toggle="theme" data-theme="city" data-css="__SHOP_CSS__/themes/city.min.css" tabindex="-1" href="javascript:void(0)">
                                    <i class="fa fa-circle text-city pull-right"></i> <span class="font-w600">City</span>
                                </a>
                            </li>
                            <li <?php if($system_color=='flat') echo  'class="active"'; ?>>
                                <a data-toggle="theme" data-theme="flat" data-css="__SHOP_CSS__/themes/flat.min.css" tabindex="-1" href="javascript:void(0)">
                                    <i class="fa fa-circle text-flat pull-right"></i> <span class="font-w600">Flat</span>
                                </a>
                            </li>
                            <li <?php if($system_color=='smooth') echo  'class="active"'; ?>>
                                <a data-toggle="theme" data-theme="smooth" data-css="__SHOP_CSS__/themes/smooth.min.css" tabindex="-1" href="javascript:void(0)">
                    ...
                    <a class="h5 text-white" href="<?php echo url('shop/index/index'); ?>">
                        ...
                        <img src="<?php echo get_shop_file_path(\think\Config::get('web_site_logo')); ?>" class="logo" alt="<?php echo (\think\Config::get('web_site_title') ?: 'Dolphin PHP'); ?>">
                        <?php else: ?>
                        <img src="<?php echo \think\Config::get('public_static_path'); ?>shop/img/logo.png" class="logo" alt="Dolphin PHP">
                        ...
                        <img src="<?php echo get_shop_file_path(\think\Config::get('web_site_logo_text')); ?>" class="logo-text sidebar-mini-hide" alt="<?php echo (\think\Config::get('web_site_title') ?: 'Dolphin PHP'); ?>">
                        <?php else: ?>
                        <img src="<?php echo \think\Config::get('public_static_path'); ?>shop/img/logo-text.png" class="logo-text sidebar-mini-hide" alt="Dolphin PHP">
                        <?php endif; ?>
                    </a>
                </div>
                <!-- END Side Header -->
            ...
            <li>
                <div class="btn-group">
                    <button class="btn btn-default btn-image dropdown-toggle" data-toggle="dropdown" type="button">
                        <img src="<?php echo get_avatar(\think\Session::get('shop_auth.uid')); ?>" alt="<?php echo session('shop_auth.username'); ?>">
                        <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li class="dropdown-header"><?php echo session('shop_auth.username'); ?> (<?php echo session('shop_auth.role_name'); ?>)</li>
                        <li>
                            <a tabindex="-1" href="<?php echo url('shop/index/profile'); ?>">
                                <i class="si si-settings pull-right"></i>个人设置
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a tabindex="-1" href="<?php echo url('shop/publics/signout'); ?>">
...
<?php else: ?>
<script src="__SHOP_JS__/core/jquery.min.js"></script>
<script src="__SHOP_JS__/core/bootstrap.min.js"></script>
<script src="__SHOP_JS__/core/jquery.slimscroll.min.js"></script>
<script src="__SHOP_JS__/core/jquery.scrollLock.min.js"></script>
<script src="__SHOP_JS__/core/jquery.appear.min.js"></script>
<script src="__SHOP_JS__/core/jquery.countTo.min.js"></script>
<script src="__SHOP_JS__/core/jquery.placeholder.min.js"></script>
<script src="__SHOP_JS__/core/js.cookie.min.js"></script>
<script src="__LIBS__/magnific-popup/magnific-popup.min.js"></script>
<script src="__SHOP_JS__/app.js"></script>
<script src="__SHOP_JS__/dolphin.js"></script>
<script src="__SHOP_JS__/builder/form.js"></script>
<script src="__SHOP_JS__/builder/aside.js"></script>
<script src="__SHOP_JS__/builder/table.js"></script>
